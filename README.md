...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-19-N/main/run.sh | sudo bash -s odoo-19-one 10015 20015 8069 8072 10.0.0.17/29 10.0.0.18 10.0.0.19 10.0.0.20 my-odoo252-net
```
