...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-19-N/main/run.sh | sudo bash -s odoo-19-one 10015 20015 8069 8072 10.0.1.5/29 10.0.1.6 10.0.1.7 10.0.1.8 my-odoo252-net
```
