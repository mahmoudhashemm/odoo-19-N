...
``` bash
curl -s https://raw.githubusercontent.com/mahmoudhashemm/odoo-19-N/main/run.sh | sudo bash -s odoo-19-one 10015 20015 8069 8072 10.0.1.0/29 10.0.1.2 10.0.1.3 10.0.1.4 my-odoo252-net
```
